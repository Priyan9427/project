...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-primary text-white" href="login.html">Sign Up</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="retro.webp" class="card-img-top" alt="Retrospective Branding Design">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="home.jpeg" class="card-img-top" alt="Home Swap Platform UI Elements">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="jewellery.avif" class="card-img-top" alt="Jewelry Website Design">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="car.avif" class="card-img-top" alt="EV Charging Station Branding">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="gym.png" class="card-img-top" alt="Fitness App UI Design">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="coffee.webp" class="card-img-top" alt="Coffee Shop Logo Design">
                        <div class="card-body">
    ...
    <footer>
        <p>&copy; 2024 U Priyan. All rights reserved.</p>
    </footer>
</body>
</html>
```
...
# OUTPUT:
![Screenshot 2024-12-29 133638](https://github.com/user-attachments/assets/0d7166f6-c328-432d-8b0a-be77f13490bc)

![Screenshot 2024-12-29 133654](https://github.com/user-attachments/assets/40c5ad9b-917e-4fcb-ad18-67c53681104a)

![Screenshot 2024-12-29 133703](https://github.com/user-attachments/assets/77bbc0fa-db68-4d9b-b5f3-8b97df054ad7)

![Screenshot 2024-12-29 133713](https://github.com/user-attachments/assets/f5b3638f-cd3f-424f-8758-2416ca130b9f)
